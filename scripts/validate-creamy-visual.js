...
check('CSS scoped bajo #creamy-widget', css.includes('#creamy-widget .creamy-window'), 'falta scope');
...
check('Input scoped', css.includes('#creamy-widget .creamy-textarea'), 'input sin scope');
